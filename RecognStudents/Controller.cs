...
namespace AForge.WindowsForms
{
    ...
    class Controller
    {
        ...
        {
            //  Масштабируем до увеличенного размера на форме
            AForge.Imaging.Filters.ResizeBilinear scaleFilter = new AForge.Imaging.Filters.ResizeBilinear(75*3, 150*3);
            Bitmap showedImage = scaleFilter.Apply(processor.processed);
            return showedImage;
        }
    }
}
